...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tweet_list = __webpack_require__(159);
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  _reactDom2.default.render(_react2.default.createElement(_tweet_list2.default, { url: '/api/' }), root);
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tweet = __webpack_require__(160);
	...
	var TweetList = function (_React$Component) {
	  ...
	  function TweetList(props) {
	    ...
	    _this.loadTweetsFromServer = _this.loadTweetsFromServer.bind(_this);
	    _this.createCurrentTweetComponents = _this.createCurrentTweetComponents.bind(_this);
	  ...
	  _createClass(TweetList, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.loadTweetsFromServer(this.props.url).then(function (data) {
	        // handle on success situation
	        var tweetsPerPage = _this2.state.tweetsPerPage;

	        var tweetsByPage = [];
	        var numPages = Math.ceil(data.length / tweetsPerPage);
	        // divide tweets by page
	        for (var i = 0; i < numPages; i++) {
	          var tweetSlice = data.slice(i * tweetsPerPage, (i + 1) * tweetsPerPage);
	          tweetsByPage.push(tweetSlice);
	        }
	        _this2.setState({ tweets: tweetsByPage, numPages: numPages });
	      });
	    }
	  }, {
	    key: 'handleClick',
	    ...
	    key: 'loadTweetsFromServer',
	    value: function loadTweetsFromServer(url) {
	      // standard ajax call
	      return $.ajax({
	        method: 'GET',
	        url: url,
	    ...
	    key: 'createCurrentTweetComponents',
	    value: function createCurrentTweetComponents() {
	      // deconstruct state object
	      var _state = this.state,
	          tweets = _state.tweets,
	          currentPage = _state.currentPage,
	          tweetsPerPage = _state.tweetsPerPage;
	      // get tweets by page, index starts from 0

	      var tweetComponents = tweets[currentPage - 1].map(function (tweet) {
	        return _react2.default.createElement(_tweet2.default, { key: tweet.id, fields: tweet });
	      });
	    ...
	    value: function createPagination() {
	      ...
	      var pageLinks = pages.map(function (i) {
	    ...
	    value: function render() {
	      var _state2 = this.state,
	          tweets = _state2.tweets,
	          currentPage = _state2.currentPage,
	          tweetsPerPage = _state2.tweetsPerPage;


	      if (tweets.length !== 0) {
	        // render all child components
	        var tweetComponents = this.createCurrentTweetComponents();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var strToLink = function strToLink(string, index) {
	  var href = "";
	  // add link to mention
	  if (string.startsWith('@')) {
	    var mention = string.slice(1);
	...
	var Tweet = function Tweet(_ref) {
	  ...
	  var words = text.split(" ").map(function (word, i) {
	    return strToLink(word, i);
	  });

	  return _react2.default.createElement(
	    'li',
	    { key: id, className: 'tweet-item' },
	    _react2.default.createElement(
	      'div',
	      { className: 'item-left' },
	      _react2.default.createElement('img', { src: profileImageUrl, alt: 'pofile-image' })
	    ),
	    _react2.default.createElement(
	      'div',
